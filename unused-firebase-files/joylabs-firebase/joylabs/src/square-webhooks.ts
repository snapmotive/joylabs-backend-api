...
export const handleWebhook = functions.https.onRequest((req, res) => {
...
async function handlePaymentCreated(merchantId: string, data: any) {
  try {
...
async function handlePaymentUpdated(merchantId: string, data: any) {
  try {
    const { payment } = data.object;
...
async function handleOrderCreated(merchantId: string, data: any) {
  try {
...
async function handleOrderUpdated(merchantId: string, data: any) {
  try {
    const { order } = data.object;
