...
app.post('/api/webhooks/square', async (req, res) => {
  try {
    ...
    const isValidSignature = await squareService.verifyWebhookSignature(signature, req.rawBody);
    ...
    console.log(
      `Processing Square webhook event: ${event.type}, event ID: ${event.event_id || 'not provided'}`
    );
